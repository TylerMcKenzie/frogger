...
project.addAssets("build_frogger/compiled/Assets/**", { notinlist: true , destination: "data/{name}"});
project.addAssets("build_frogger/compiled/Shaders/*.arm", { notinlist: true , destination: "data/{name}"});
project.addAssets("/home/tyler/armory_ext/armsdk/armory/Assets/brdf.png", { notinlist: true , destination: "data/{name}"});
project.addAssets("/home/tyler/armory_ext/armsdk/armory/Assets/smaa_area.png", { notinlist: true , destination: "data/{name}"});
project.addAssets("/home/tyler/armory_ext/armsdk/armory/Assets/smaa_search.png", { notinlist: true , destination: "data/{name}"});
project.addAssets("Bundled/Truck_L_brown.png", { notinlist: true , destination: "data/{name}"});
project.addAssets("Bundled/Truck_L_green.png", { notinlist: true , destination: "data/{name}"});
project.addAssets("Bundled/Truck_L_red.png", { notinlist: true , destination: "data/{name}"});
project.addAssets("Bundled/Truck_M_brown.png", { notinlist: true , destination: "data/{name}"});
project.addAssets("Bundled/Truck_M_green.png", { notinlist: true , destination: "data/{name}"});
project.addAssets("Bundled/Truck_M_red.png", { notinlist: true , destination: "data/{name}"});
project.addAssets("Bundled/Truck_S_brown.png", { notinlist: true , destination: "data/{name}"});
project.addAssets("Bundled/Truck_S_green.png", { notinlist: true , destination: "data/{name}"});
project.addAssets("Bundled/Truck_S_red.png", { notinlist: true , destination: "data/{name}"});
project.addAssets("Bundled/canvas/Frogger.files", { notinlist: true , destination: "data/{name}"});
project.addAssets("Bundled/canvas/Frogger.json", { notinlist: true , destination: "data/{name}"});
project.addAssets("Bundled/canvas/TitleCanvas.files", { notinlist: true , destination: "data/{name}"});
project.addAssets("Bundled/canvas/TitleCanvas.json", { notinlist: true , destination: "data/{name}"});
...
project.addAssets("/home/tyler/armory_ext/armsdk/armory/Assets/font_default.ttf", { notinlist: false , destination: "data/{name}"});
